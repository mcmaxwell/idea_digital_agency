...
class Info(models.Model):
    ...
    facebook_link = models.CharField(blank=False, null=False, max_length=255, verbose_name=_('facebook_link'))
    insta_link = models.CharField(blank=False, null=False, max_length=255, verbose_name=_('insta_link'))
    twitter_link = models.CharField(blank=False, null=False, max_length=255, verbose_name=_('twitter_link'))
